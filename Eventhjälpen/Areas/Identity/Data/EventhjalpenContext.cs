...
namespace Eventhjalpen.Data
{
    public class EventhjalpenContext : IdentityDbContext<EventhjalpenUser>
    {

        public EventhjalpenContext(DbContextOptions<EventhjalpenContext> options)
            : base(options)
        {
        }
